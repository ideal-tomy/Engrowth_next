...
export default function Vision() {
  return (
    <div className="vision-page">
      <HeroSection 
        title="Vision"
        subtitle={"「すべての人に、可能性を信じて生きる力を」<br />誰もが第二言語（英語）を使い、夢を掴む社会を目指して"}
        bgColor="gradient"
        textColor="light"
        align="center"
        height="medium"
      ...
      <section className="ecosystem-title-image section-padding alt-bg">
        <div className="container">
          <StylishTitle 
            ...
            size="large"
          />
          <Image src="/images/visionimage01.png" alt="Engrowth Ecosystem Concept" width={800} height={400} className="ecosystem-image" />
        </div>
      </section>
